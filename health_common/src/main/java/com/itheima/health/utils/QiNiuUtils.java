...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "PtFdIkHSeH8NIjClYBTu7brwGxsvhJYNNYmDWwV8";
    private static final String SECRETKEY = "y88VXYQEqSCeAiyYHEoikIF6jv5XEAgZScTJQt7z";
    private static final String BUCKET = "arui97";
    public static final String DOMAIN= "http://qh0c2jh34.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\HP\\Desktop\\12.jpg","2.jpg");
