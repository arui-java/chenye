...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203187028";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "栀子娱乐";/// 短信的签名，属于验证码签名
	private static final String PARAMETER_NAME="code";// 短信模板内容中的参数名
	private static final String ACCESS_KEY="LTAI4GF5nWQsxNK5ZSY88qXB"; //你的AccessKey ID
	private static final String SECRET_KEY="K6SwRtyA58rKPIZnw3EZMthXc4Vniq"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"13333654655","745982");
	}

	/**
	 *发送短信
	 * @param templateCode   验证码模板code
	 * @param phoneNumbers   接收的手机号
	 * @param param   验证码
